...
$lang_phrases = [
    ...
    "Hi {---1}, Please validate my phone number using this ID: {---2}" => "",
    "Driver arrived first stop" => "",
    "Your driver has arrived at your first stop" => "",
    "Driver arrived stop" => "",
    "Your driver has arrived at your stop" => "",
    "Trip has resumed" => "",
    "Your driver has resumed the trip and is heading to your next stop" => "",
    "Your driver has resumed the trip and is heading to your destination" => "",
    "Driver arrived second stop" => "",
    "Your driver has arrived at your second stop" => "",
