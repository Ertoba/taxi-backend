                      ...
                      <form  enctype="multipart/form-data" id="reg-form" class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['SCRIPT_NAME']); ?>" method="post" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input  style="display: inline-block;width:calc(100% - 90px);" type="number"  required="required" class="form-control" id="phone" placeholder="" name="phone" value="<?php echo !empty($_POST["phone"]) ? $_POST["phone"] : ''; ?>" >
                                </div>
