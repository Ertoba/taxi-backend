                            ...
                            ?>
                                    <div class="row" >
                                        ...
                                        <div id="<?php echo "ride-tariffs-".$count ?>" class="col-sm-12 <?php echo "ride-tariffs-".$count ?>" style="display:none;">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">                                                    
                                                    <div style="margin-top:15px;font-weight:bold;">Compute Fare with Trip Meter <input title="" type="checkbox" class="t-input" id="<?php echo "faretype-".$ridesarray['id']; ?>" name="<?php echo "faretype-".$ridesarray['id']; ?>"></div>
                                                ...
                                                <div class="col-sm-12">                                                    
                                                    <div style="margin-top:15px;font-weight:bold;">Enable Ride Sharing <input title="" type="checkbox" class="t-input" id="<?php echo "rideshare-".$ridesarray['id']; ?>" name="<?php echo "rideshare-".$ridesarray['id']; ?>"></div>
                                                ...
                                                <div class="col-sm-12">                                                    
                                                    <div style="margin-top:15px;font-weight:bold;">Enable Hourly Rate <input data-item="<?php echo $count; ?>" type="checkbox" class="hourlyrate-en-chkbox t-input" id="<?php echo "hourlyrate-".$ridesarray['id']; ?>" name="<?php echo "hourlyrate-".$ridesarray['id']; ?>"></div>
                                                    ...
                                                    <div class="row" id="hourly-rate-set-<?php echo $count;?>" style="display:none;">
                                                        <div class="col-sm-12">
                                                            <div class="row">
                                                                <div class="col-sm-3">
                                                                    <p style="margin-top: 15px;margin-bottom: 2px;">Cost per hour</p>
                                                                    <input  type="number"  min="0" step="0.01" disabled="disabled" required= "required" class="form-control hourlyrate-t-input" id="<?php echo "cph-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "cph-".$ridesarray['id']; ?>" value="<?php $indx = "cph-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                                </div>

                                                                <div class="col-sm-3">
                                                                    <p style="margin-top: 15px;margin-bottom: 2px;">Distance (KM)</p>
                                                                    <input  type="number"  min="1" step="0.1" disabled="disabled" required= "required" class="form-control hourlyrate-t-input" id="<?php echo "cphdist-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "cphdist-".$ridesarray['id']; ?>" value="<?php $indx = "cphdist-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <p style="margin-top: 15px;margin-bottom: 2px;">Cost per hour</p>
                                                                    <input  type="number"  min="0" step="0.01" disabled="disabled" required= "required" class="form-control hourlyrate-t-input" id="<?php echo "ncph-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "ncph-".$ridesarray['id']; ?>" value="<?php $indx = "ncph-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                                </div>

                                                                <div class="col-sm-3">
                                                                    <p style="margin-top: 15px;margin-bottom: 2px;">Distance (KM)</p>
                                                                    <input  type="number"  min="1" step="0.1" disabled="disabled" required= "required" class="form-control hourlyrate-t-input" id="<?php echo "ncphdist-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "ncphdist-".$ridesarray['id']; ?>" value="<?php $indx = "ncphdist-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <input  type="number"  min="0" step="1"  disabled="disabled" required= "required" class="form-control t-input" id="<?php echo "wt-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "wt-".$ridesarray['id']; ?>" value="<?php $indx = "wt-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                </div>
                                                
                                                <div class="col-sm-3">
                                                    <p style="margin-top: 15px;margin-bottom: 2px;">Wait Cost per Minute</p>
                                                    <input  type="number"  min="0.00" step="0.01"  disabled="disabled" required= "required" class="form-control t-input" id="<?php echo "wcpmr-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "wcpmr-".$ridesarray['id']; ?>" value="<?php $indx = "wcpmr-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <p style="margin-top: 15px;margin-bottom: 2px;">Wait time</p>
                                                    <input  type="number"  min="0" step="1"  disabled="disabled" required= "required" class="form-control t-input" id="<?php echo "nwt-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "nwt-".$ridesarray['id']; ?>" value="<?php $indx = "nwt-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                </div>

                                                <div class="col-sm-3">
                                                    <p style="margin-top: 15px;margin-bottom: 2px;">Wait Cost per Minute</p>
                                                    <input  type="number"  min="0.00" step="0.01"  disabled="disabled" required= "required" class="form-control t-input" id="<?php echo "nwcpmr-".$ridesarray['id']; ?>" placeholder="" name="<?php echo "nwcpmr-".$ridesarray['id']; ?>" value="<?php $indx = "nwcpmr-".$ridesarray['id']; echo isset($_POST[$indx]) ? $_POST[$indx] : ''; ?>" > 
                                                </div>
                                            </div>
