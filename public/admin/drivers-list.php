...
$schd_bk_status = isset($_GET['schd_bk']) ? 2 : 1;
...
<html>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 table-responsive" style="height:100%;margin-bottom: 100px;">
                    <?php echo isset($_GET['schd_bk']) ? "<h3 style='text-align:center;' >Assign Driver To Scheduled Booking ". (!empty($booking_id) ? "#{$booking_id}": "") . "</h3>" : "<h3 style='text-align:center;' >Dispatch Driver For Booking ". (!empty($booking_id) ? "#{$booking_id}": "") . "</h3>";?>
                    <hr>
    ...
    <script src="../js/bootstrap.min.js"></script>
     <script>
        var status = <?php echo $schd_bk_status;?>;
        $('#driverselectdone').click(function(){
            $("#okclicked").val(status);
