                ...
                <div class="box box-info">
                    ...
                    <form id="general_form" method="POST" action="{{ route('admin.pushnotificationupdate') }}"
                        ...
                        <div class="form-group mt-3">
                            <label class="col-sm-3 control-label" for="onesignal_app_id">Rider App ID<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-6">
                                <input class="form-control" type="text" name="onesignal_app_id" id="onesignal_app_id"
                                    placeholder="OneSignal Rider App ID" value="{{ $onesignal_app_id ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            <label class="col-sm-3 control-label" for="onesignal_rest_api_key">Rider App API Key<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-6">
                                <input class="form-control" type="password" name="onesignal_rest_api_key"
                                    id="onesignal_rest_api_key" placeholder="OneSignal Rider App API Key"
                        ...
                        <div class="form-group mt-3">
                            <label class="col-sm-3 control-label" for="onesignal_app_id_driver">Driver App ID<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-6">
                                <input class="form-control" type="text" name="onesignal_app_id_driver"
                                    id="onesignal_app_id_driver" placeholder="OneSignal Driver App ID"
                                    value="{{ $onesignal_app_id_driver ?? '' }}">
                            </div>
                        </div>

                        <div class="form-group mt-3">
                            <label class="col-sm-3 control-label" for="onesignal_rest_api_key_driver">Driver App API Key<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-6">
                                <input class="form-control" type="password" name="onesignal_rest_api_key_driver"
                                    id="onesignal_rest_api_key_driver" placeholder="OneSignal Driver App API Key"
