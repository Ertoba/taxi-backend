   ...
   <div class="autoFillOtp">
    ...
    <label class="switch">
        ...
        @php
            ...
            if ($providerName == 'nonage') {
                $url = route('admin.smssetting');
            } elseif ($providerName == 'twillio') {
            ...
            } elseif ($providerName == 'ubill') {
                $url = route('admin.ubillSetting');
            }
        @endphp
    ...
    <li class="{{ Request::route()->getName() === 'admin.ubillSetting' ? 'active' : '' }}">
        <a href="{{ route('admin.ubillSetting') }}">uBILL</a>
    </li>
   <!-- <li class="{{ Request::route()->getName() === 'admin.twilliosetting' ? 'active' : '' }}">
