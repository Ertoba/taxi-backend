...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::get('settings/ubill', [GeneralSettingController::class, 'ubillSetting'])->name('ubillSetting');
    Route::post('settings/updateUbill', [GeneralSettingController::class, 'ubillUpdate'])->name('updateUbill');
