...
class FirestoreService
{
    ...
    protected function transformValue($value)
    {
        if (is_string($value)) {
            ...
            $fields = $this->transformData((array) $value);

            // Firestore requires an empty map to be encoded as JSON `{}`.
            // A PHP empty array is encoded as `[]` and is rejected by the API.
            return ['mapValue' => ['fields' => $fields ?: new \stdClass]];
        } else {
