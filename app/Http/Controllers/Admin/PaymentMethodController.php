...
class PaymentMethodController extends Controller
{
    protected $paymentMethods = [
        ...
        'keepz' => [
            'meta_keys' => [
                'test_keepz_identifier',
                'test_keepz_integrator_id',
                'test_keepz_receiver_id',
                'test_keepz_receiver_type',
                'test_keepz_public_key',
                'test_keepz_private_key',
                'live_keepz_identifier',
                'live_keepz_integrator_id',
                'live_keepz_receiver_id',
                'live_keepz_receiver_type',
                'live_keepz_public_key',
                'live_keepz_private_key',
                'keepz_options',
                'keepz_status',
                'onlinepayment',
            ],
            'view' => 'admin.generalSettings.payment-methods.form',
            'options_field' => 'keepz_options',
            'status_field' => 'keepz_status',
            'title' => 'Keepz',
            'fields' => [
                'identifier',
                'integrator_id',
