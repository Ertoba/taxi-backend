...
class ItemsApiController extends Controller
{
    ...
    public function editItem(Request $request)
    {
        ...
        // Updating vehicle details must not reset Firestore runtime state such as
        // document approval, online status, location or the current ride request.
        $firestoreData = $this->generateDriverProfileFirestoreData($userData);
